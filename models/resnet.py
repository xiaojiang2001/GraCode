...
class MoEAdapter(nn.Module):
    def __init__(self, input_channels, num_experts=4, output_channels=128, negative_slope=0.2, top_k=1):
...
class ResNetSegmentationModelWithMoE(nn.Module):
    ...
    def _conv_block(self, in_channels, out_channels):
        ...
        return nn.Sequential(
            ...
            nn.LeakyReLU(),
            MoEAdapter(input_channels=out_channels, output_channels=out_channels, num_experts=4),
        )
