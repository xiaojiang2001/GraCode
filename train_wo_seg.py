    ...
    for epoch in range(Epoch):
        ...
        for vis_rain, vis_gt, inf_image, vis_rain224, vis_gt224, inf_image224, label in train_tqdm:
            ...
            with torch.cuda.amp.autocast():
                ...
                _, fusion, vi, ir = fusion_model(vis_rain, inf_image)
                _, fusion_224, vi_224, ir_24 = fusion_model(vis_rain224, inf_image224)
                # Loss functions
        ...
        if epoch % 5 ==0:
            ...
            torch.save(fusion_model.state_dict(), f'{save_path}/fusion_wo_seg.pth')
